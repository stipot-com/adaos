...
def list_capability_classes() -> list[dict[str, Any]]:
    return [
        ...
        _capability_entry(
            ...
            surface="operations",
            risk="high",
            summary="Start a supervisor-owned profiler session on a managed target.",
            default_grants=["owner_token"],
        ),
        _capability_entry(
            ...
            surface="operations",
            risk="high",
            summary="Stop a supervisor-owned profiler session on a managed target.",
            default_grants=["owner_token"],
        ),
        _capability_entry(
            ...
            surface="operations",
            risk="high",
            summary="Retry a supervisor-owned profiler session on a managed target.",
            default_grants=["owner_token"],
        ),
        _capability_entry(
            ...
            surface="operations",
            risk="high",
            summary="Publish a supervisor-owned profiler session from a managed target to root.",
            default_grants=["owner_token"],
        ),
        _capability_entry(
            "hub.deploy_ref",

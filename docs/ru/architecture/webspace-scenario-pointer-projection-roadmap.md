...
Из-за этого остаточная стоимость reopen теперь гораздо явнее концентрируется
в настоящих detached recovery path после room/store drop, а не в штатном
создании комнаты у живого runtime.
